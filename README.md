...
## For smaller screens (mobile, tablet etc.)

Perhaps you want to test some feature or design on a smaller screen? Download [ngrok](https://ngrok.com/download/linux) and then run `ngrok http 8000`. In `base.html` use built assets instead of ones served from `localhost:5173`. In order to do this comment out line that looks like this
